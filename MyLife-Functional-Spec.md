...
- Subcollections per project: `todoItems` ({text, done, notes, sortOrder}), `planningGroups` ({name, sortOrder, items[]}), `days`, `bookings`, `bookingPhotos`, `itemPhotos`, `itemPhotoData`, `packingItems`, `projectNotes`
...
**Delete cascade**: Removes all subcollection docs (days, bookings, bookingPhotos, projectPhotos, itemPhotos, itemPhotoData, todoItems, packingItems, projectNotes, planningGroups, projectLocations) before deleting the project doc.
