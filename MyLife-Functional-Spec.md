...
- **Evidence chips**: base rate, RSI 14, 5d/60d volume ratio, 60d realized vol, above/below 50d + 200d averages, 52-week range, earnings chip when known, plus the Stage 2.2 quality/insider/falling-knife chips (same `_asQualityChips` set as the scan card).
