...
| `HoldingsHealthPlan.md` | Life → Financial | **Goal 2** — forward-looking health check on stocks you already own. Per-holding verdict (✅ Healthy / 👀 Watch / ⚠️ Review exit) from flag-count of 5 exit checks (estimate deterioration [flagship, mirror of Detector C], trend vs 50/200d, analyst momentum, quality/falling-knife, earnings risk) + regime context. Its own tool on the Analyzer hub. **Plan frozen 2026-07-19, no code yet** — 3 resumable pieces (A: checks engine, B: page, C: docs/About). Mostly assembly: snapshot coverage already includes holdings |
