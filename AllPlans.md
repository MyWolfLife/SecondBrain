...
| `TradingStrategiesPlan.md` | Life → Financial | Trading strategies investigation — top index-beating strategies (dual momentum, stock momentum, quality-value, PEAD, news sentiment), teaching + implementation docs + one app feature per surviving strategy. Phases 1–3 complete; awaiting user cut of 2 candidates |
