...
const ALL_PAGES = [
    ...
    'budget', 'budget-archive', 'budget-nonmonthly',
    'analyzer', 'analyzer-dipdrift', 'analyzer-dualmomentum', 'analyzer-dm-about', 'analyzer-stockmomentum', 'analyzer-sm-about', 'analyzer-qualityvalue', 'analyzer-qv-about', 'analyzer-earningsdrift', 'analyzer-pead-about', 'analyzer-newssentiment', 'analyzer-news-about', 'analyzer-holdingshealth', 'analyzer-universe', 'analyzer-backtest', 'analyzer-scan', 'analyzer-dossier', 'analyzer-trades', 'analyzer-scoreboard',
...
function handleRoute() {
    ...
    } else if (page === 'analyzer' && id === 'dualmomentum' && parts[2] === 'about') {
        showPage('analyzer-dm-about');
        loadAnalyzerDualMomentumAboutPage();
    } else if (page === 'analyzer' && id === 'dualmomentum') {
        showPage('analyzer-dualmomentum');
        loadAnalyzerDualMomentumPage();
    } else if (page === 'analyzer' && id === 'stockmomentum' && parts[2] === 'about') {
        showPage('analyzer-sm-about');
        loadAnalyzerStockMomentumAboutPage();
    } else if (page === 'analyzer' && id === 'stockmomentum') {
        showPage('analyzer-stockmomentum');
        loadAnalyzerStockMomentumPage();
    } else if (page === 'analyzer' && id === 'qualityvalue' && parts[2] === 'about') {
        showPage('analyzer-qv-about');
        loadAnalyzerQualityValueAboutPage();
    } else if (page === 'analyzer' && id === 'qualityvalue') {
        showPage('analyzer-qualityvalue');
        loadAnalyzerQualityValuePage();
    } else if (page === 'analyzer' && id === 'earningsdrift' && parts[2] === 'about') {
        showPage('analyzer-pead-about');
        loadAnalyzerEarningsDriftAboutPage();
    } else if (page === 'analyzer' && id === 'earningsdrift') {
        showPage('analyzer-earningsdrift');
        loadAnalyzerEarningsDriftPage();
    } else if (page === 'analyzer' && id === 'newssentiment' && parts[2] === 'about') {
        showPage('analyzer-news-about');
        loadAnalyzerNewsSentimentAboutPage();
    } else if (page === 'analyzer' && id === 'newssentiment') {
        showPage('analyzer-newssentiment');
        loadAnalyzerNewsSentimentPage();
    } else if (page === 'analyzer' && id === 'holdingshealth') {
        showPage('analyzer-holdingshealth');
        loadAnalyzerHoldingsHealthPage();
    ...
    } else if (page === 'analyzer' && id === 'trades') {
        showPage('analyzer-trades');
        loadAnalyzerTradesPage();
    } else if (page === 'analyzer' && id === 'scoreboard') {
        showPage('analyzer-scoreboard');
