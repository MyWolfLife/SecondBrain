...
'',
'ADD_PROJECT — a multi-step improvement, renovation, or ongoing effort that has a defined goal and may involve planning or multiple phases. Examples: "Install drip irrigation in the back yard", "Build a raised garden bed", "Repaint the shed". Use when the user is describing something they want to plan or undertake, not just a single chore.',
...
'',
'ADD_TASK — a single, specific to-do item or chore that can be done in one step. Examples: "Trim the hedges in the back yard", "Check tire pressure on the truck", "Clean the gutters". Use when the user says "add a task", "to-do", "I need to do X", or any single short actionable chore. Distinct from ADD_PROJECT which implies a larger multi-step effort.',
