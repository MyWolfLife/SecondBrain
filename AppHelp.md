...
- **Last 7 Days**: shown only when viewing the current month and year. On desktop it appears as a row at the top of the table (above the Goals row) — weight shows how much you lost or gained over the last 7 days, Total Miles shows the period total, and the other columns show averages (booleans show X / 7). On mobile it's a collapsible summary card you can expand or collapse, and your choice is remembered between visits.
